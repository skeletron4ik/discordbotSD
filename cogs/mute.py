...
class MuteCog(commands.Cog):
    ...
    async def mute(self, inter: disnake.GuildCommandInteraction, участник: disnake.Member, время: str, причина='Причина не указана.'):
        ...
        embed.add_field(name='**Подробная информация:**', value=f'Модератор: {inter.author.name} ({inter.author.mention})\n'
